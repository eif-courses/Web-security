...
- Web application should have functionallity against top 10 OWASP (Open Web Application Security Project) vulnerabilities (https://www.owasp.org/index.php/Top_10_2013-Top_10). 
